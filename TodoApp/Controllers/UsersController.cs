...
namespace TodoApp.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserName,Password,RoleIds,Roles,Todoes")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserName,Password,RoleIds,Roles")] UserEditViewModel user)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //dbUser.UserName = user.UserName;//ユーザー名は変更しない
        ...
        {
            var roles = userRoles.Select(items=>items.Id).ToArray();
